    ...
    private fun startCamera() {
        imageClassifierHelper = ImageClassifierHelper(
            ...
            classifierListener = object : ImageClassifierHelper.ClassifierListener {
                ...
                override fun onResults(results: List<ImageClassifierHelper.Classifications>, inferenceTime: Long) {
                    runOnUiThread {
                        results.let {
                            if (it.isNotEmpty()) {
                                val displayResult = it.joinToString("\n") { classification ->
                                    "${classification.label}: ${NumberFormat.getPercentInstance().format(classification.score)}"
                                }
